...
export default function Footer() {
  return (
    <footer className="bg-[#B7C2CB] py-2 lg:py-12">
      <div className="wrapper">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 grid-cols-1 auto-cols-auto gap-x-10 xl:gap-x-28">
          <div className="text-primary lg:order-2 py-7 lg:py-0 last:border-b-0 md:border-b-0 border-b-2 border-primary">
            <h3 className="text-2xl md:text-4xl mb-5 md:mb-7 font-heading font-medium">
              HEAD OFFICE
            </h3>
            <ul className="grid grid-cols-1 gap-y-5">
              <li className="w-full relative text-base flex">
                <MapPinIcon className="w-6 h-6 text-primary mr-3 flex-none grow-0" />
                <span className="grow">
              ...
              <li className="w-full relative text-base flex">
                <PhoneIcon className="w-6 h-6 text-primary mr-3 flex-none grow-0" />
                <a
              ...
              <li className="w-full relative text-base flex">
                <EnvelopeIcon className="w-6 h-6 text-primary mr-3 flex-none grow-0" />
                <a
                  className="grow hover:text-secondary"
          ...
          <div className="text-primary lg:order-3 py-7 lg:py-0 last:border-b-0 md:border-b-0 border-b-2 border-primary">
            ...
            <div className="flex gap-2 items-end">
              ...
              <div className="text-center max-w-28 flex-none grow-0 md:block hidden">
          ...
          <div className="text-primary lg:order-1 py-7 lg:py-0 lg:col-span-1 md:col-span-2 last:border-b-0 md:border-b-0 border-b-2 border-primary">
            ...
            <div className="flex items-end justify-between">
              <ul className="mt-4 lg:mt-7 grid grid-cols-1 gap-1">
                <li>
                  <a
                    href="#"
